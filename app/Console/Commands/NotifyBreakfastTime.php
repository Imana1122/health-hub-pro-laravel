...
class NotifyBreakfastTime extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:notify-breakfast-time';
     ...
     * @var string
     */
    protected $description = 'Breakfast notification';
