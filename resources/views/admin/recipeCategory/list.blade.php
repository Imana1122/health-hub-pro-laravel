...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Recipe Categorys</h1>
            </div>
            <div class="col-sm-6 text-right">
                <a href="{{ route("recipeCategories.create") }}" class="btn btn-primary">New Recipe Category</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route('recipeCategories.index') }}' " class="btn btn-default btn-sm">Reset</button>
                    </div>
                    ...
                    <tbody>
                        @if($recipeCategories->isNotEmpty())
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('recipeCategories.edit',$recipeCategory->id) }}">
                                        <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                        </svg>
                                    </a>
                                    <a href="#" onClick="deleteCategory('{{ $recipeCategory->id }}')" class="text-danger w-4 h-4 mr-1">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Are you sure you want to delete this recipeCategory?</p>
                            </div>
...
<script>
    function deleteCategory(id) {
        var url = '{{ route('recipeCategories.destroy', "ID") }}';
