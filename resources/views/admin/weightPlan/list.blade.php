    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route("weightPlans.create") }}" class="btn btn-primary">New Meal Type</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <form action="" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route('weightPlans.index') }}' " class="btn btn-default btn-sm">Reset</button>
                    </div>
                    ...
                    <tbody>
                        @if($weightPlans->isNotEmpty())
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('weightPlans.edit',$weightPlan->id) }}">
                                        <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                        </svg>
                                    </a>
                                    <a href="#" onClick="deleteCategory('{{ $weightPlan->id }}')" class="text-danger w-4 h-4 mr-1">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Are you sure you want to delete this weightPlan?</p>
                            </div>
...
<script>
    function deleteCategory(id) {
        var url = '{{ route('weightPlans.destroy', "ID") }}';
        ...
        $('#confirmDeleteBtn').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = "{{ route('weightPlans.index') }}";
                },
                headers: {
